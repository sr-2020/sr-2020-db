drop table if exists scoring_factor_calculate;
drop table if exists scoring_category_calculate;
drop table if exists current_category;
drop table if exists current_factor;
drop table if exists event_lifestyle;
drop table if exists scoring_factor;
